...
<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#eeeeee" >
                                                ...
                                                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container" align="center" >
                                                    ...
                                                    <tr >
                                                        <td align="center" class="hund" width="600" >
                                                            <img src="' . site_url() . '/wp-content/uploads/2019/06/canelle-logo.png" width="300" alt="Logo" border="0" style="max-width: 300px; display:block; " >
                                                        </td >
                                                    </tr >
                                                    <!--END HEADER IMAGE-->
                                                </table >
    ...
    <table align="center" border="0" cellspacing="0" cellpadding="0" width="600" >
        <tr >
            <td align="center" valign="top" width="600" height="18" ><![endif]-->
    <tr >
        <td height="18px" ></td >
    </tr >
    <!--[if gte mso 9]></td >
    ...
    <table align="center" border="0" cellspacing="0" cellpadding="0" width="600" >
        <tr >
            <td align="center" valign="top" width="600" height="36" ><![endif]-->
    <tr >
        <td height="36px" ></td >
    </tr >
    <!--[if gte mso 9]></td >
